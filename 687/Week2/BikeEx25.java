...
/**
 * @author Radhika
 * Exercise 25 - Design a class Bike with following fields and member functions for accomplishing the given  requirements.   
 * Fields: bikeRegNo, bikeName, maxSpeed, currentSpeed, currentGear  
 * Member Functions:  applyBreak() :It should reduce the currentSpeed to zero and currentGear to 1  
 ...
 */
 ...
 public class BikeEx25 {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Bike myBike = new Bike (1,"Delsol",50,45,2);
