...
public class Trainee implements Serializable {
	...
	private static final long serialVersionUID = 4456355226702038782L;
	...
	public Trainee() {
		// Creating a trainee record with id =1 and unknown name and email id
		this(1,"Unknown Name","","unknown@unknown.com","",0);
	}
	...
	public int hashCode() {
		final int prime = 31;
		//int result = 1;
		//updated result to store traineeId as this id would be unique
