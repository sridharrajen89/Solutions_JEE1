...
public class CompanyHashMapMain {

	static HashMap<Integer,Employee> empHashMap = new HashMap<Integer,Employee>();
	static Employee emp = new Employee();
	static CompanyHashMap comp = new CompanyHashMap(1,"HTC Global Services","HTC@Gmail.com",empHashMap);
	static Scanner eid;
	...
	private static void printCompanyEmployees(){
		// TODO Auto-generated method stub
		if (empHashMap.size()!=0) {
			System.out.println(comp.getCompanyName()+" has total "+empHashMap.size()+" employees");
