...
import com.htc.jdbc.examples.EmployeeJDBC.DuplicateEmployeeIDException;
import com.htc.jdbc.examples.EmployeeJDBC.HTCGlobal;
 ...
 class EmployeeJDBC{
	...
	interface IEmployeeServiceProvider {
	 ...
	 public static class HTCGlobal implements IEmployeeServiceProvider{
...
public class CRUDOperationUsingJDBC {
	...
	public static void main(String[] args) throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
		...
		EmployeeJDBC empJDBC =new EmployeeJDBC (123,"ram",123.00);
		HTCGlobal htc = new HTCGlobal();
		try {
			htc.insertRecord(empJDBC);
