...
public class CRUDOperationUsingHashMap1 {
	...
	public static void main(String[] args) {
		...
		HashMap<Integer, Employee> comList = new HashMap<Integer, Employee>();
		
		try {
			Employee employee;
			CompanyMap companymap = new CompanyMap(1111, "HTC", "abcd@htcinc.com", comList);
			...
			System.out.println("Reading " +companymap.readEmployee(1234));
			System.out.println("Reading " +companymap.readEmployee(2345));
			System.out.println("Reading " +companymap.readEmployee(1100));
			System.out.println("Reading " +companymap.readEmployee(101));
			System.out.println("Reading " +companymap.readEmployee(123));
